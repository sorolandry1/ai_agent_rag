...
def query_rag(chain, question):
    """Interroge la chaîne RAG et affiche la réponse."""
    print("\nQuestion :", question)
    try:
...
if __name__ == "__main__":
    try:
        ...
        # 4. Indexation ou chargement de la base vectorielle
